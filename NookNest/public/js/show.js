...
const offeringsPopup = document.querySelectorAll(".amenities-popup table tr td");
const offeringList = [
    "Kitchen facilities",
    "Living room",
    "Fridge",
...
offeringsPopup.forEach(offering => {
    replaceOfferingIcons(offering);
})
...
function replaceOfferingIcons(offering) {
    switch (offering.innerHTML) {
        ...
        case "Lake view":
            ...
            break;
        case "Dining table":
            offering.innerHTML = `<i class="fa-solid fa-chair me-3"></i></td><td>Lake view`;
            break;
        case "Mountain view":
...
const amenitiesBtn = document.querySelector(".show-amenities-btn");
